...
<body>
	...
	<jsp:setProperty name='admin' property='userName' value='admin' />
	<jsp:setProperty name='admin' property='passWord' value='pass' />
	...
	<div class="container-login100" style="background-image: url('images/bg-012.jpg');">
		<div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
			<form class="login100-form validate-form" method= "POST" action="admin.jsp">
